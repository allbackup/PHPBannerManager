...
$fields[3]["name"]="(select manual,paypal,authorize,echo-inc,2checkout,verysign,worldpay,paysystems) Credit Card Processor Gateway";
$fields[3]["define"]="CC_PROCESSOR_TYPE";
$fields[3]["default"]="manual";
$fields[4]["comment"][]="Enable/Disable Address Verification Service - Manual Processing";
$fields[4]["name"]="(radio yes,no) Enable AVS";
$fields[4]["define"]="CC_AVS";
$fields[4]["default"]="yes";
$fields[5]["comment"][]="Some Payment Gateway need SSL to process payment(authorize, echo-inc). Click <a href=\"javascript: ;\" onclick=\"newwin=window.open('testssl.php?todo=testssl','_blank','width=300,height=150,scrollbars=yes,menubar=no,resizable=yes,location=no');\" class=\"settings\">here</a> to see if you can enable this option.";
...
$fields[10]["default"]="install@bitmixsoft.c0m";
...
$fields[13]["comment"][]="To use Authorize.net you need curl module installed (enabled). Click <a href=\"javascript: ;\" onclick=\"newwin=window.open('testcurl.php?desc=Authorize.net','_blank','width=300,height=150,scrollbars=yes,menubar=no,resizable=yes,location=no');\" class=\"settings\">here</a> to see if you have this module.";
...
$fields[18]["comment"][]="To use echo-inc.com you need curl module installed (enabled). Click <a href=\"javascript: ;\" onclick=\"newwin=window.open('testcurl.php?desc=echoinc.net','_blank','width=300,height=150,scrollbars=yes,menubar=no,resizable=yes,location=no');\" class=\"settings\">here</a> to see if you have this module.";
$fields[18]["comment"][]="Echoinc.com Processing settings";
$fields[18]["name"]="Echo-inc.com Account";
$fields[18]["define"]="ECHO_INC_COM_LOGIN";
$fields[18]["default"]="123>4682174";
$fields[19]["name"]="Echo-inc.com PIN";
$fields[19]["define"]="ECHO_INC_COM_PASSWORD";
$fields[19]["default"]="26649175";
...
$fields[32]["default"]="yes";
$fields[33]["comment"][]="_________________________________________________________________";
$fields[33]["comment"][]="Paysystems Processing settings";
$fields[33]["name"]="Paysystems URL";
$fields[33]["define"]="PAYSYSTEMS_COM_URL";
$fields[33]["default"]="https://secure.paysystems1.com/cgiv310/payment/onlinesale-tpppro.asp";
$fields[34]["comment"][]="";
$fields[34]["name"]="Paysystems Company ID";
$fields[34]["define"]="PAYSYSTEMS_COM_ACCOUNT";
$fields[34]["default"]="181548";
?>