...
$fields = array (
        ...
        "order_number" => array("%%paysystems_order_number%%" , "Paysystems Order Number", "12323234"),
        "order_status" => array("%%paysystems_order_status%%" , "Paysystems Order Status", "This transaction has been approved"),		
